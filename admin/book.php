...
include('db_connect.php');
	$rid = '';
//variabel untuk menghitung waktu masuk dan keluar
...
<div class="container-fluid">
	...
	<form action="" id="manage-check">
		...
		<?php
			$id = ($_GET['cid']);
			$cat = $conn->query("SELECT * FROM room_categories where id = '$id'")->fetch_array();
		 ?>
		...
		<div class="form-group">
			<label for="days">Amount (Price * Days)</label>
			<input type="text" name="price" id="price" class="form-control" value="<?php echo 'Rp'.number_format($cat['price'] * $calc_days ,2) ?>" required readonly>
		</div>
		<div class="form-group">
